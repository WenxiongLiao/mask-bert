...
parser.add_argument("--model", type=str, default='bert', help="model (base,trinity)")
...
parser.add_argument("--input_seq_len", required=False, type=int, default=512, help="maximum sequence input len")
...
parser.add_argument("--task", type=str, required=False, default='pretrain', help="model (base,trinity)")
...
model = RobertaPretrain_utterence(model_name="bert")
