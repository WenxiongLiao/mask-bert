...
class Trainer:
    def __init__(self, task, model,
                 ...
                 lr: float = 1e-4, betas=(0.9, 0.999), weight_decay: float = 0.01, warmup_steps=1000,epoch: int = 8,
    ...
    def train(self, epoch,pre_train_model_path):
        self.iteration(epoch, self.train_data,pre_train_model_path)

    def iteration(self, epoch, data_loader,pre_train_model_path, train=True):
        ...
        #                 + "_" + self.model_name
        self.model.model.save_pretrained(pre_train_model_path)
        ...
        print("EP:%d Model Saved on:" % epoch, pre_train_model_path)
